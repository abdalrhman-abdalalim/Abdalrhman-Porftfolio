...
const HeroScreen = ({ onContactClick }: IProps) => {
  return (
    <div className="relative min-h-screen bg-linear-to-br from-gray-900 via-black to-gray-900 overflow-hidden px-20">
      {/* Enhanced Background Effects */}
      <div className="absolute top-0 right-0 w-3/4 sm:w-1/2 h-3/4 sm:h-1/2 bg-linear-to-br from-pink-500/20 to-purple-600/20 blur-3xl rounded-full z-10 animate-pulse"></div>
      <div
        className="absolute bottom-0 left-0 w-3/4 sm:w-1/2 h-3/4 sm:h-1/2 bg-linear-to-tr from-blue-600/20 to-cyan-500/20 blur-3xl rounded-full z-10 animate-pulse"
